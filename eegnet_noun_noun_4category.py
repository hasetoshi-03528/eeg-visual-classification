...
epochs_1_test = epochs_1[600:700,:,:]
...
epochs_3_train = epochs_3[:600,:,:]
epochs_3_test = epochs_3[600:700,:,:]
print("epochs_3_train",epochs_3_train.shape)
print("epochs_3_test",epochs_3_test.shape)

tmp=np.vstack((epochs_1_train, epochs_2_train))
set_1_train = np.vstack((tmp, epochs_3_train))
tmp=np.vstack((epochs_1_test, epochs_2_test))
set_1_test = np.vstack((tmp, epochs_3_test))

epochs_4_train = epochs_4[:600,:,:]
epochs_4_test = epochs_4[600:700,:,:]
print("epochs_4_train",epochs_4_train.shape)
print("epochs_4_test",epochs_4_test.shape)
epochs_5_train = epochs_5[:600,:,:]
epochs_5_test = epochs_5[600:700,:,:]
print("epochs_5_train",epochs_5_train.shape)
print("epochs_5_test",epochs_5_test.shape)
epochs_6_train = epochs_6[:600,:,:]
epochs_6_test = epochs_6[600:700,:,:]
print("epochs_6_train",epochs_6_train.shape)
print("epochs_6_test",epochs_6_test.shape)

tmp=np.vstack((epochs_4_train, epochs_5_train))
set_2_train = np.vstack((tmp, epochs_6_train))
tmp=np.vstack((epochs_4_test, epochs_5_test))
set_2_test = np.vstack((tmp, epochs_6_test))

epochs_7_train = epochs_7[:600,:,:]
epochs_7_test = epochs_7[600:700,:,:]
print("epochs_7_train",epochs_7_train.shape)
print("epochs_7_test",epochs_7_test.shape)
epochs_8_train = epochs_8[:600,:,:]
epochs_8_test = epochs_8[600:700,:,:]
print("epochs_8_train",epochs_8_train.shape)
print("epochs_8_test",epochs_8_test.shape)
epochs_9_train = epochs_9[:600,:,:]
epochs_9_test = epochs_9[600:700,:,:]
print("epochs_9_train",epochs_9_train.shape)
print("epochs_9_test",epochs_9_test.shape)

tmp=np.vstack((epochs_7_train, epochs_8_train))
set_3_train = np.vstack((tmp, epochs_9_train))
tmp=np.vstack((epochs_7_test, epochs_8_test))
set_3_test = np.vstack((tmp, epochs_9_test))

epochs_10_train = epochs_10[:600,:,:]
epochs_10_test = epochs_10[600:700,:,:]
print("epochs_10_train",epochs_10_train.shape)
print("epochs_10_test",epochs_10_test.shape)
epochs_11_train = epochs_11[:600,:,:]
epochs_11_test = epochs_11[600:700,:,:]
print("epochs_11_train",epochs_11_train.shape)
print("epochs_11_test",epochs_11_test.shape)
epochs_12_train = epochs_12[:600,:,:]
epochs_12_test = epochs_12[600:700,:,:]
print("epochs_12_train",epochs_12_train.shape)
print("epochs_12_test",epochs_12_test.shape)

tmp=np.vstack((epochs_10_train, epochs_11_train))
set_4_train = np.vstack((tmp, epochs_12_train))
tmp=np.vstack((epochs_10_test, epochs_11_test))
set_4_test = np.vstack((tmp, epochs_12_test))

epochs_train= np.vstack((set_1_train, set_2_train, set_3_train, set_4_train))
epochs_test = np.vstack((set_1_test, set_2_test, set_3_test, set_4_test))
print("epochs_train",epochs_train.shape)
print("epochs_test",epochs_test.shape)

train_labels = np.zeros(7200, dtype=np.int64)
train_labels[1800:3600] = 1
train_labels[3600:5400] = 2
train_labels[5400:7200] = 3

test_labels = np.zeros(1200, dtype=np.int64)
test_labels[300:600] = 1
test_labels[600:900] = 2
test_labels[900:1200] = 3
