...
epochs_train_1 = np.vstack((epochs_1_train_a,epochs_1_train_b))
epochs_test_1 = np.vstack((epochs_1_test_a, epochs_1_test_b))
epochs_train_2 = np.vstack((epochs_2_train_a,epochs_2_train_b))
epochs_test_2 = np.vstack((epochs_2_test_a, epochs_2_test_b))
epochs_train_3 = np.vstack((epochs_3_train_a,epochs_3_train_b))
epochs_test_3 = np.vstack((epochs_3_test_a, epochs_3_test_b))
epochs_train_4 = np.vstack((epochs_4_train_a,epochs_4_train_b))
epochs_test_4 = np.vstack((epochs_4_test_a, epochs_4_test_b))
epochs_train_5 = np.vstack((epochs_5_train_a,epochs_5_train_b))
epochs_test_5 = np.vstack((epochs_5_test_a, epochs_5_test_b))
epochs_train_6 = np.vstack((epochs_6_train_a,epochs_6_train_b))
epochs_test_6 = np.vstack((epochs_6_test_a, epochs_6_test_b))
epochs_train_7 = np.vstack((epochs_7_train_a,epochs_7_train_b))
epochs_test_7 = np.vstack((epochs_7_test_a, epochs_7_test_b))
epochs_train_8 = np.vstack((epochs_8_train_a,epochs_8_train_b))
epochs_test_8 = np.vstack((epochs_8_test_a, epochs_8_test_b))
epochs_train_9 = np.vstack((epochs_9_train_a,epochs_9_train_b))
epochs_test_9 = np.vstack((epochs_9_test_a, epochs_9_test_b))
epochs_train_10 = np.vstack((epochs_10_train_a,epochs_10_train_b))
epochs_test_10 = np.vstack((epochs_10_test_a, epochs_10_test_b))
epochs_train_11 = np.vstack((epochs_11_train_a,epochs_11_train_b))
epochs_test_11 = np.vstack((epochs_11_test_a, epochs_11_test_b))
epochs_train_12 = np.vstack((epochs_12_train_a,epochs_12_train_b))
epochs_test_12 = np.vstack((epochs_12_test_a, epochs_12_test_b))

epochs_train= np.vstack((epochs_train_1, epochs_train_2, epochs_train_3, epochs_train_4, epochs_train_5, epochs_train_6, epochs_train_7, epochs_train_8, epochs_train_9, epochs_train_10, epochs_train_11, epochs_train_12))
epochs_test = np.vstack((epochs_test_1, epochs_test_2, epochs_test_3, epochs_test_4, epochs_test_5, epochs_test_6, epochs_test_7, epochs_test_8, epochs_test_9, epochs_test_10, epochs_test_11, epochs_test_12))
